    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          ...
          <p> SH.<?php echo htmlentities($result->PricePerDay);?> </p>Per Route
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Please include your route. And the time you will be available for pick up." required></textarea>
            </div>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">SH.<?php echo htmlentities($result->PricePerDay);?></p>
